...
@Component({
  selector: 'app-del-servicio',
  templateUrl: './del-servicio.component.html',
  styleUrls:['./servicios.component.css']
})
export class DelServicioComponent implements OnInit {
  ...
  deleteServicio(){
    ...
    const body:ServiciosModel={
      idServicios:this.selectedItem.idServicios,
     
    }

    this.smgService.delServicios(body).subscribe(resp=>{
      if(resp.error){
