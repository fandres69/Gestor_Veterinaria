...
@Component({
  selector: 'app-upd-servicio',
  templateUrl: './upd-servicio.component.html',
  styleUrls:['./servicios.component.css']
})
export class UpdServicioComponent implements OnInit {
  ...
  updateServicio(){
    ...
    this.smgService.updServicios(body).subscribe(resp=>{
      if(resp.error){
