...
@Component({
  selector: 'app-upd-ingreso',
  templateUrl: './upd-ingreso.component.html',
  styleUrls:['./ingresos-inventario.component.css']
})
export class UpdIngresoComponent implements OnInit {
  ...
  updateStockIn(){
    ...
    this.smgService.updIngresosInv(body).subscribe(resp=>{
      if(resp.error){
