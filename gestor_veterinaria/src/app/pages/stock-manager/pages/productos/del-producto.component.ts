...
@Component({
  selector: 'app-del-producto',
  templateUrl: './del-producto.component.html',
...
/**
 ...
 loadCiudades(){
  ...
  deleteProducto(){
    ...
    const body={
      idProductos:this.selectedItem.idProductos     
    }
    this.smgService.delProduct(body).subscribe(resp=>{
      if(resp.error){
