...
@Component({
  selector: 'app-upd-inventarios',
  templateUrl: './upd-inventarios.component.html',
  styleUrls:['./inventarios.component.css']
})
export class UpdInventariosComponent implements OnInit {
  ...
  updateInventario(){
    ...
    const body:StockModel={
      ...
      producto:this.selectedItem[0].producto,
      stock:this.selectedItem[0].stock,
    ...
    this.smgService.updInventario(body).subscribe(resp=>{
      if(resp.error){
