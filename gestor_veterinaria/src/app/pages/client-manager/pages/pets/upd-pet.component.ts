...
@Component({
  selector: 'app-upd-pet',
  templateUrl: './upd-pet.component.html',
  styleUrls: ['./pets.component.css'
  ]
})
export class UpdPetComponent implements OnInit {
  ...
  updateMascota(){
    ...
    const body:Mascotas={
      ...
      idmascotas:this.selectedItem.idmascotas
    }
    this.clientS.updPet(body).subscribe(resp=>{
      if(resp.error){
