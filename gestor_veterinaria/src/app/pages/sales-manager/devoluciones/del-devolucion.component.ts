...
@Component({
  selector: 'app-del-devolucion',
  templateUrl: './del-devolucion.component.html',
  styleUrls:['./devoluciones.css']
})
export class DelDevolucionComponent implements OnInit {
...
deleteDevolucion(){
  ...
  this.salesMng.deleteDevolucion(this.vistaDetalleUpdate).subscribe(resp=>{
    if(resp.error){
