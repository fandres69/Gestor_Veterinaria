...
@Component({
  ...
  templateUrl: './upd-pedidos.component.html',
  styleUrls: ['./pedidos.component.css' ]
})
export class UpdPedidosComponent implements OnInit {
  ...
  createPedido(){
    ...
    const body:PedidoModel={   
      idpedidos:this.OrderForUpd.idpedidos,
      cliente:this.OrderForUpd.documento,
    ...
    this.salesMng.updateOrder(body).subscribe(resp=>{
      if(resp.error){
