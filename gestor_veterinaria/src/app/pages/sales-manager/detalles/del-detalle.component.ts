...
@Component({
  selector: 'app-del-detalle',
  templateUrl: './del-detalle.component.html',
  styleUrls:['./detalles.css']
})
export class DelDetalleComponent implements OnInit {
  ...
  public vistaDetalleUpdate!:VistaDetalle;
...
deleteDetalle(){
  ...
  this.salesMng.delDetalle(det).subscribe(resp=>{
    if(resp.error){
